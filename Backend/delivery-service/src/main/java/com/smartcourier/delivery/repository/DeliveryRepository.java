...
public interface DeliveryRepository extends JpaRepository<Delivery, Long> {
    ...
    long countByCurrentHubId(Long hubId);

    boolean existsByCustomerUsernameAndSenderNameAndReceiverNameAndSourceAndDestinationAndCreatedAtAfter(
            String customerUsername, String senderName, String receiverName,
            String source, String destination, LocalDateTime after);
}
